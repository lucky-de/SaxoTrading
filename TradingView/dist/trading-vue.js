/*!
 * TradingVue.JS - v1.0.2 - Thu Sep 16 2021
...
var Legendvue_type_template_id_34724886_render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.grid_id === 0
    ? _c(
        "div",
        { ref: "tb", staticClass: "chart-toolbar", style: _vm.calc_style },
        [
          _c(
            "div",
            {
              class:
                "order-control " +
                (_vm.$store.getters.get_stock(_vm.stock).closed ? "closed" : "")
            },
            [
              _c(
                "div",
                {
                  staticClass: "order-button-container",
                  on: {
                    mouseover: function($event) {
                      _vm.showByIndex = 0
                    },
                    mouseleave: function($event) {
                      _vm.showByIndex = null
                    }
                  }
                },
                [
                  _c(
                    "button",
                    {
                      staticClass: "order-button sell",
                      on: {
                        click: function($event) {
                          return _vm.handleOrder("sell")
                        }
                      }
                    },
                    [
                            ...
                            innerHTML: _vm._s(
                              _vm.stock != null
                                ? _vm.$options.filters.formatPrice(
                                    this.$store.getters.get_stock(_vm.stock)
                                      .price.sell,
                                    this.$store.getters.get_stock(_vm.stock)
                                      .category
                                  )
                  ...
                  _vm._v(" "),
                  _vm.showByIndex == 0 &&
                  !_vm.$store.getters.get_stock(_vm.stock).closed
                    ? _c("div", { staticClass: "volume-select" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
              ...
              _vm._v(" "),
              _c("div", { staticClass: "spread-wrapper" }, [
                _c("div", { staticClass: "spread" }, [
                  _c("em", [
                    _vm._v(
                      _vm._s(
                        _vm.spread(this.$store.getters.get_stock(_vm.stock))
                      )
                    )
                  ])
                ])
              ...
              _c(
                ...
                [
                  _c(
                    "button",
                    {
                      staticClass: "order-button buy",
                      on: {
                        click: function($event) {
                          return _vm.handleOrder("buy")
                        }
                      }
                    },
                    [
          ...
          _vm._v(" "),
          _vm.fulltb
            ? _c("div", { staticClass: "buttons veil" }, [
                _c("section", [
                  _c("i", {
                    staticClass: "font-icon icon_new_order",
                    attrs: { title: "Create New Order" },
                    on: { click: _vm.newOrder }
                  }),
                  _vm._v(" "),
                  _c("i", {
                    staticClass: "font-icon icon_periods_m1",
                    attrs: { title: "Period" },
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        return _vm.$refs.period.open($event)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("i", {
                    staticClass: "font-icon icon_chart_type_candles",
                    attrs: { title: "Chart Type" },
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        return _vm.$refs.chart_type.open($event)
                      }
                    }
                  })
                ]),
                ...
                _c("section", [
                  _c("i", {
                    class: [
                      "font-icon",
                      "icon_panning",
                      { highlighted: _vm.highlighted == 0 }
                    ],
                    attrs: { title: "Panning" },
                    on: { click: _vm.panning }
                  }),
                  _vm._v(" "),
                  _c("i", {
                    class: [
                      "font-icon",
                      "icon_crosshair",
                      { highlighted: _vm.highlighted == 1 }
                    ],
                    attrs: { title: "Crosshair Cursor" },
                    on: { click: _vm.cursor }
                  }),
                  _vm._v(" "),
                  _c("i", {
                    class: [
                      "font-icon",
                      "icon_lines_trend",
                      { highlighted: _vm.highlighted == 2 }
                    ],
                    attrs: { title: "Drawings" },
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        return _vm.$refs.drawings.open($event)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _c("i", {
                    class: [
                      "font-icon",
                      "icon_indicators",
                      { highlighted: _vm.highlighted == 4 }
                    ],
                    attrs: { title: "Indicators" },
                    on: { click: _vm.openIndicators }
                  }),
                  _vm._v(" "),
                  _c("i", {
                    class: [
                      "font-icon",
                      "icon_graph_objects",
                      { highlighted: _vm.highlighted == 5 }
                    ],
                    attrs: { title: "List of drawings on chart" },
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        return _vm.$refs.obj_manager.open($event)
                      }
                    }
                  })
                ]),
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.objectHandled,
                        expression: "objectHandled"
                      }
                    ],
                    staticClass:
                      "font-icon far fa-plus-square mdi mdi-trash-can-outline",
                    staticStyle: { color: "#ff6969 !important" },
                    attrs: { title: "Remove Object" },
                    on: { click: _vm.rmObject }
                  })
                ])
              ])
            : _c("div", { staticClass: "buttons veil" }, [
                _c("section", [
                  _c("i", {
                    class: ["font-icon", "icon_window_menu"],
                    attrs: { title: "Actions" },
                    on: {
                      click: function($event) {
                        return _vm.$easycm($event, _vm.$root, _vm.wndID)
                      }
                    }
                  }),
                  _vm._v(" "),
          ...
          _vm._v(" "),
          _c("vue-context", { ref: "drawings" }, [
            _c("div", { staticClass: "menu" }, [
              _c(
                "div",
                {
                  staticClass: "menu-item selected",
                  on: {
                    click: function($event) {
                      return _vm.figures(0)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_lines_trend " })
                  ]),
                  _vm._v(" "),
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ),
              _vm._v(" "),
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.figures(1)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_lines_fibo_fan " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Fibonacci Retracement")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", {
                      staticClass: "font-icon icon_lines_fibo_arc-57 "
                    })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Fibonacci Fan")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", {
                      staticClass: "font-icon icon_lines_fibo_arc-96 "
                    })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Fibonacci Arc")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ...
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.figures(4)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_lines_fibo_timez " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Fibonacci Timezone")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", {
                      staticClass: "font-icon icon_lines_vert_market "
                    })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Vertical Marker")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ...
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.figures(6)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_lines_hor_market " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Horizontal Marker")
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "menu-item-children" })
                ]
              ...
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.figures(7)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_lines_rectangle " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Rectangle")
              ...
              _c(
                "div",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.figures(8)
                    }
                  }
                },
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_lines_ellipse " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Ellipse")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", {
                      staticClass: "font-icon icon_lines_abcd_pattern "
                    })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
          ...
          _c("vue-context", { ref: "period" }, [
            _c("div", { staticClass: "menu" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_periods_m1 " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("1 minute")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_periods_m2 " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("5 minutes")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_periods_m15 " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("15 minutes")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_periods_m30 " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("30 minutes")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_periods_h1 " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("1 hour")
          ...
          _c("vue-context", { ref: "chart_type" }, [
            _c("div", { staticClass: "menu" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_chart_type_bar " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Bar Chart")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_chart_ha_candles " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Heikin Ashi")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_chart_type_hlc " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("HLC Chart")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_chart_type_line " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Line Chart")
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "menu-item-icon" }, [
                    _c("i", { staticClass: "font-icon icon_chart_type_dots " })
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "menu-item-text" }, [
                    _vm._v("Dots Chart")
          ...
          _vm._v(" "),
          _c("vue-context", { ref: "obj_manager" }, [
            _vm.objects != null && _vm.objects.length > 0
              ? _c(
                  "ul",
                  { staticClass: "menu v-context" },
                  _vm._l(_vm.objects, function(object) {
                    return _c(
                      "div",
                      { key: object.name, staticClass: "menu" },
                      [
                        _c(
                          "div",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.manageObject(object)
                              }
                            }
                          },
                          [
                            ...
                            _vm._v(" "),
                            _c("span", { staticClass: "menu-item-text" }, [
                              _vm._v(_vm._s(object.last.name))
                            ]),
                            _vm._v(" "),
                            _c("div", { staticClass: "menu-item-children" }, [
                              _c("i", {
                                staticClass: "font-icon icon_win_close",
                                on: {
                                  click: function($event) {
                                    return _vm.manageObject(object, true)
                                  }
                                }
                              })
                            ])
              ...
              : _c(
                  ...
                  [
                    _c("span", { staticClass: "menu-item-text" }, [
                      _vm._v("No objects present on chart")
                    ])
                  ]
                )
          ]),
          _vm._v(" "),
          _vm.ohlcv_show
            ? _c("div", { staticClass: "vert-legend" }, [
                _c("div", { staticClass: "ohlcv" }, [
                  _c("section", [
                    _c("span", [
                      _vm._v(
                        "\n            " +
                ...
                _vm._v(" "),
                _vm.indicators && _vm.indicators.length > 0
                  ? _c(
                      "div",
                      { staticClass: "inds" },
...
var compatible = (/^2\./).test(vue_runtime_esm.version);
if (!compatible) {
  vue_runtime_esm.util.warn('VueClickaway ' + version + ' only supports Vue 2.x, and does not support Vue ' + vue_runtime_esm.version);
}
...
function vue_clickaway_bind(el, binding, vnode) {
  unbind(el);
...
var vue_clickaway_directive = {
  bind: vue_clickaway_bind,
  update: function(el, binding) {
    if (binding.value === binding.oldValue) return;
    vue_clickaway_bind(el, binding);
  },
  unbind: unbind,
};

var mixin = {
  directives: { onClickaway: vue_clickaway_directive },
};
...
const utils_setAttr = (el, attr, value) => {
...
/* harmony default export */ const vue_context = ({
    directives: {
        onClickaway: vue_clickaway_directive
    },
    ...
    methods: {
        ...
        setItemRoles() {
            ...
            selectAll(this.localItemSelector, this.$el)
                .forEach(el => {
                    utils_setAttr(el, 'role', 'menuitem');
                    utils_setAttr(el, 'tabindex', '-1');
                });
        }
    },
...
;// CONCATENATED MODULE: ./src/helpers/menus.json
const menus_namespaceObject = JSON.parse('{"time":[{"text":"1 minute"},{"text":"5 minutes"},{"text":"15 minutes"},{"text":"30 minutes"},{"text":"1 hour"}],"type":[{"text":"Bar Chart"},{"text":"Candlesticks"},{"text":"Heikin Ashi"},{"text":"HLC Chart"},{"text":"Line Chart"},{"text":"Dots Chart"}],"drawings":[{"text":"Trendline"},{"text":"Fibonacci Retracement"},{"text":"Fibonacci Fan"},{"text":"Fibonacci Arc"},{"text":"Fibonacci Timezone"},{"text":"Vertical Marker"},{"text":"Horizontal Marker"},{"text":"Rectangle"},{"text":"Ellipse"},{"text":"ABCD Pattern"}],"indicators":[{"text":"Price Range"},{"text":"Time Range"},{"text":"Price & Time Range"}]}');
...
function Legendvue_type_script_lang_js_createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = Legendvue_type_script_lang_js_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }

function Legendvue_type_script_lang_js_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return Legendvue_type_script_lang_js_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Legendvue_type_script_lang_js_arrayLikeToArray(o, minLen); }

function Legendvue_type_script_lang_js_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
/* harmony default export */ const Legendvue_type_script_lang_js_ = ({
  name: 'ChartLegend',
  props: ['common', 'values', 'grid_id', 'meta_props', 'instrument', 'wndID'],
  components: {
  ...
  mounted: function mounted() {
    ...
    try {
      //hide ohlcv
      this.$refs.tb.closest('.window-frame').addEventListener('mouseenter', function () {
        _this.ohlcv_show = true;
      });
      this.$refs.tb.closest('.window-frame').addEventListener('mouseleave', function () {
        _this.ohlcv_show = false;
      }); //responsive-ish legend

      var tbListener = new ResizeObserver(function (e) {
        if (!_this.$refs.tb) return;
        if (_this.$refs.tb.offsetWidth <= 450) _this.fulltb = false;
  ...
  created: function created() {
    ...
    this.$store.subscribe(function (mutation, state) {
      if (mutation.type == "broadcast") {
        if (mutation.payload.wndID != _this2.wndID) return;

        if (mutation.payload.event == 'chart_internal_event') {
          _this2.interpretInternalEvent(mutation.payload.body);

          if (mutation.payload.body.client) {
            mutation.payload.body.client = false;

            _this2.$emit('custom-event', mutation.payload.body);
          }
        }

        if (mutation.payload.event == 'periodChange') {
          var content = mutation.payload.body;
        }

        if (mutation.payload.event == 'typeChange') {
          var _content = mutation.payload.body;
        }
      }
    });
  },
  computed: {
    objects: function objects() {
      var objects = [];
      var overlays = this.common.data;
      overlays.forEach(function (overlay) {
        if (overlay.last.drawing === true) objects.push(overlay);
      });
      return objects;
    },
    ...
    indicators: function indicators() {
      ...
      return this.json_data.filter(function (x) {
        ...
        return {
          ...
          name: x.name || id,
          index: (_this3.off_data || _this3.json_data).indexOf(x),
          id: id,
          values: values ? f(id, values) : _this3.n_a(1),
          unk: !(id in (_this3.$props.meta_props || {})),
          loading: x.loading
        };
      });
    },
  ...
  filters: {
    formatPrice: function formatPrice(price, category) {
      // Convert the price to string and seperate both parts
      var array = [];
      if (category == 'forex') array = price.toFixed(5).split(".");else array = price.toFixed(2).split("."); // Convert number parts to array so they could join later

      var number = array[0].split("");
      var decimals = array[1].split("");
  ...
  methods: {
    manageObject: function manageObject(object, del) {
      if (!del) del = false;
      this.$store.commit('broadcast', {
        ...
        body: {
          event: 'object-selected',
          client: true,
          args: [object.grid.id, object.name, object.settings.$uuid]
        }
      });
      if (del) this.$store.commit('broadcast', {
        event: 'chart_internal_event',
        wndID: this.wndID,
        body: {
          event: 'tool-selected',
    ...
    openIndicators: function openIndicators() {
      this.$emit('custom-event', {
    ...
    interpretInternalEvent: function interpretInternalEvent(e) {
      switch (e.event) {
        case "remove-tool":
        ...
        case "grid-mousedown":
          if (this.currentTool != null && this.currentTool != "System:Remove" && this.currentTool != "Panning" && this.currentTool != "Cursor") {
            this.objectHandled = true;
          } else {
            this.objectHandled = false;
            this.highlighted = 0;
    ...
    rmObject: function rmObject() {
      this.$emit('custom-event', {
        event: 'tool-selected',
        args: ['System:Remove']
      });
    },
    altcm: function altcm() {
      this.$emit('custom-event', {
        ignore: true,
        event: 'altcm',
        wndID: this.wndID
    ...
    handleOrder: function handleOrder(dir) {
      if (!this.$store.getters.get_stock(this.stock).closed) this.$emit('custom-event', {
        event: 'quick_order',
        args: {
          vol: this.volume,
          direction: dir
    ...
    toggleCheck: function toggleCheck(index, childrenID) {
      if (index == 0) index = 'time';
      if (index == 1) index = 'type';
      if (index == 2) index = 'drawings';

      var _iterator = Legendvue_type_script_lang_js_createForOfIteratorHelper(this.labels[index]),
          _step;
    ...
    objmng: function objmng(idx) {},
    period: function period(idx) {
      switch (idx) {
        case 0:
          {
            this.$emit('custom-event', {
    ...
    indicatorsMenu: function indicatorsMenu(idx) {
      var _this5 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                tool = null;
                _context2.t0 = idx[0];
                _context2.next = _context2.t0 === 0 ? 4 : _context2.t0 === 1 ? 6 : _context2.t0 === 2 ? 8 : 10;
                break;
              ...
              case 10:
                _this5.$emit('custom-event', {
                  event: 'tool-selected',
                  args: [tool]
                });

                _this5.highlighted = 3;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                tool = null;
                _context3.t0 = idx;
                _context3.next = _context3.t0 === 0 ? 4 : _context3.t0 === 1 ? 6 : _context3.t0 === 2 ? 8 : _context3.t0 === 3 ? 10 : _context3.t0 === 4 ? 12 : _context3.t0 === 5 ? 14 : _context3.t0 === 6 ? 16 : _context3.t0 === 7 ? 18 : _context3.t0 === 8 ? 20 : _context3.t0 === 9 ? 22 : 24;
                break;
              ...
              case 24:
                _this6.$emit('custom-event', {
                  event: 'tool-selected',
                  args: [tool]
                });

                _this6.highlighted = 2;
    ...
    pleaseWork: function pleaseWork() {// yay
    },
...
/* harmony default export */ const Sectionvue_type_script_lang_js_ = ({
  name: 'GridSection',
  props: ['common', 'grid_id', 'instrument', 'wndID'],
  mixins: [shaders],
  components: {
...
/* harmony default export */ const Chartvue_type_script_lang_js_ = ({
  name: 'Chart',
  props: ['title_txt', 'data', 'width', 'height', 'font', 'colors', 'overlays', 'tv_id', 'config', 'buttons', 'toolbar', 'ib', 'skin', 'timezone', 'instrument', 'wndID'],
...
/* harmony default export */ const TradingVuevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    custom_event: function custom_event(d) {
      //console.log("TRADINGVUE", d)
      // if(d.event == 'legend-button-click')
      //  console.log(d)
      if (d.ignore) {
        this.$parent.$emit('custom-event', d);
        return;
      }

      this.$store.commit('broadcast', {
        //bounce event to the whole system
        event: 'chart_internal_event',
        wndID: this.id,
        body: d
      });
